...
const timelineData: TimelineItem[] = [
  ...
  },
  {
    ...
    company: "Snap Inc.",
    description: "Built and service mesh infrastructure powering real-time communication for hundreds of millions of users.",
  ...
  },
  {
    ...
    title: "Software Engineer, Machine Learning",
    company: "Meta Inc.",
    description: "Working on classifers (fine tuned LLMs) and safety eval to block unsafe contents generated from AI",
